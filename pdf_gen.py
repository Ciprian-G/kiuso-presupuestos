...
def generar_pdf(path, lineas, cliente, descuento_extra=0, descuento_extra_label="",
                comision=0, comision_label="", comision_suma=True, opciones=None):
    """
    ...
    notas = [
        ...
        "• El descuento del 5% será válido exclusivamente para pedidos confirmados dentro de los 10 días siguientes a la entrega del presupuesto final.",
    ]
    for nota in notas:
